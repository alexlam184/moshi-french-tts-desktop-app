...
from .tts import PiperEngine, SupertonicEngine, TTSResult
...
class TTSManager:
    ...
    def __init__(self, settings: AppSettings, cache: AudioCache):
        ...
        self.cache = cache
        self._engines: dict[tuple[str, str], PiperEngine | SupertonicEngine] = {}

    @staticmethod
    def models() -> list[str]:
        return [TTSManager.SUPERTONIC_MODEL, TTSManager.PIPER_MODEL]
